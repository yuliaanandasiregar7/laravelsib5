    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <hr>
               Berikut ini adalah perbandingan gender dari pelanggan dengan pelanggan total {{$pelanggan}}
...
// var myLineChart = new Chart(ctx, {
    ...
    var isi = [@foreach ($hitung_harga as $hitung) {{$hitung->harga_jual}},@endforeach];
    document.addEventListener("DOMContentLoaded", () =>{
